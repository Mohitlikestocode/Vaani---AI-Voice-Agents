    ...
    <section id="roi" data-testid="roi-calculator" className="px-6 py-28 md:px-10 md:py-40">
      <div className="mx-auto max-w-[1400px]">
        <Reveal className="mb-16 max-w-3xl">
          ...
          <h2 className="mt-5 font-serif text-5xl font-light leading-[1.02] tracking-tight text-swara-ink md:text-7xl">
            Every missed call is money walking away.
          </h2>
          <p className="mt-6 max-w-xl text-lg text-swara-muted">
            Drag the sliders to match your business. See what Swara recovers by
        ...
        <div className="grid items-center gap-16 lg:grid-cols-[0.9fr_1.1fr]">
            ...
            {controls.map((c) => (
              <div key={c.id}>
                <div className="mb-4 flex items-end justify-between">
                  <label className="text-sm text-swara-muted">{c.label}</label>
                  <span className="font-mono text-2xl font-semibold text-swara-ink">{c.display}</span>
                </div>
                <Slider
          ...
          <Reveal delay={0.1}>
            <div className="relative overflow-hidden rounded-[28px] bg-swara-ink p-10 text-white md:p-14">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-4 text-white/70">in revenue Swara would have saved you.</p>

                <div className="mt-10 grid grid-cols-2 gap-6 border-t border-white/15 pt-8">
                  <div>
                    <p className="font-display text-4xl font-semibold text-swara-gold" data-testid="roi-calls-day">
                      {Math.round(missedPerDay)}
                    </p>
                    <p className="mt-1 text-sm text-white/60">calls/day answered, not missed</p>
                  </div>
                  <div>
                    <p className="font-display text-4xl font-semibold text-swara-gold" data-testid="roi-recovered">
                ...
                <a
                  href="#pricing"
                  data-testid="roi-cta"
                  className="group mt-10 inline-flex items-center gap-2 rounded-full bg-swara-gold px-7 py-4 text-sm font-medium text-white transition-transform duration-300 hover:-translate-y-0.5"
                >
                  Start saving with Swara
        ...
        <p className="mt-8 font-mono text-xs text-swara-muted">
          Estimate based on recovered calls Ã— average value Ã— 30 days. Most
