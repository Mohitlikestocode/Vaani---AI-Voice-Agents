...
const steps = [
  {
    ...
    icon: PenLine,
    title: "Describe",
    body: "Tell Swara about your business in plain words — or just drop a link. It reads your menu, hours, services and FAQs in seconds.",
  ...
  },
  {
    ...
    icon: Rocket,
    title: "Go live",
    body: "Publish with a single line of code, share a link, or point your number at Swara. It starts answering from second one.",
                ...
                >
                  ...
                  <div className="mb-8 flex items-center justify-between">
                    <span
                      className={`flex h-12 w-12 items-center justify-center rounded-2xl transition-colors duration-[1400ms] ${
                        isActive ? "bg-swara-cream/15 text-swara-gold" : "bg-swara-maroon/10 text-swara-maroon"
                      }`}
                    >
                    ...
                    <span
                      className={`font-serif text-6xl font-light leading-none transition-colors duration-[1400ms] ${
                        isActive ? "text-swara-gold" : "text-swara-gold-soft"
                      }`}
                    >
                      {s.n}
                    </span>
                  ...
                  <h3
                    className={`font-serif text-3xl font-light transition-colors duration-[1400ms] ${
                      isActive ? "text-swara-cream" : "text-swara-maroon"
                    }`}
                  >
                    {s.title}
                  </h3>
                  <p
                    className={`mt-3 flex-1 transition-colors duration-[1400ms] ${
                      isActive ? "text-swara-cream/80" : "text-swara-muted"
                    }`}
                  >
                    {s.body}
                  </p>
                    ...
                    {s.detail.map((d) => (
                      <span
                        ...
                        className={`rounded-full px-3 py-1.5 font-mono text-[11px] transition-colors duration-[1400ms] ${
                          isActive ? "bg-swara-cream/12 text-swara-cream/90" : "bg-swara-sand text-swara-ink"
                        }`}
                      >
                        {d}
                      </span>
